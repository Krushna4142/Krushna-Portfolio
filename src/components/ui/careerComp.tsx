...
import { TimelineHead } from "@/app/(home)/TimelineHead";
...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            className="bg-black w-full dark:bg-neutral-950 font-sans px-4 md:px-10"
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto py-8 md:px-8 lg:px-10 flex flex-col items-center">
